        ...
        card.innerHTML = `
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 pb-2 border-bottom">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="./tag.html?tag=${tag}" class="btn btn-outline-primary btn-sm py-0 px-2 small"><i class="bi bi-book me-1"></i>Story &amp; Rules</a>
                </div>
            ...
            <div class="row g-3 mt-1 small">
                ...
                <div class="col-md-6">
                    ...
                    ${childTags.length > 0 
                        ? childTags.map(child => `<span class="badge bg-secondary-subtle text-secondary font-monospace me-1">&lt;${child}&gt;</span>`).join("")
