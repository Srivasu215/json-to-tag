...
const purchasesMenu = currentMenu.purchasesMenu || currentMenu;
...
// Write to docs/menu/menu.json
fs.writeFileSync("docs/menu/menu.json", JSON.stringify(allHeaders, null, 4), "utf-8");
console.log("Successfully wrote all 9 headers to docs/menu/menu.json!");
